...
def main():
    auth_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0IiwiZXhwIjoxNzQ2MjA0NDIxfQ.3JBA8qA0RRREhXHd9qzE-P5LAjwtlnZ103xF72Ha16A"
    client = SecureTCPClient(auth_token=auth_token)
    client.perform()
